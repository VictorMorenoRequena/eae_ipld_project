...
min_height = 0 
max_height = 550   # TODO: Replace None with the maximum height of the image using np.shape() function

min_width = 0
max_width = 4400    # TODO: Replace None with the maximum width of the image using np.shape() function   
...
crop_arr =  # TODO: Generate the crop array into a new variable, use NumPy array slicing
